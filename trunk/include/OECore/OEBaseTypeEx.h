...
enum CLEAR_SCREEN_MASK
{
	CSM_UNKNOWN		= 0,
	CSM_TARGET		= 0x00000001,
	CSM_ZBUFFER		= 0x00000002,
	CSM_STENCIL		= 0x00000004,
};
...
enum COLOR_WRITE_CHANNEL
{
	CWC_UNKNOWN		= 0x00000000,
	CWC_RED			= 0x00000001,
	CWC_GREEN		= 0x00000002,
	CWC_BLUE		= 0x00000004,
	CWC_ALPHA		= 0x00000008,
